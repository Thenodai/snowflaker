...
const generateSnowflake = (p5: p5Types, line: any, list: Array<Line>) => {
    ...
    const a = new Line(p5, line.startVector, a1);
    const c = new Line(p5, a1, c1);
    const c2 = new Line(p5, c1, b1);
    const b = new Line(p5, b1, line.endVector);
